...
func test_sub[V int8 | int16 | int32 | uint8 | uint16 | uint32](from V, to V) (int64, int64) {
...
/*
	var goodu16, badu16 = test_sub(uint16(0), uint16(0xe00))
	v0.1.1: min time 0.750 s
	when is_signed returns the Kind(), we get 0.380 s
*/

func TestSSubI8(t *testing.T) {
	var goodi8, badi8 = test_sub(int8(math.MinInt8), int8(math.MaxInt8))
...
func TestSSubU8(t *testing.T) {
	var goodu8, badu8 = test_sub(uint8(0), uint8(math.MaxUint8))
...
func TestSSubI16(t *testing.T) {
	// var goodi16, badi16 = test_sub(int16(math.MinInt16), int16(math.MaxInt16))
	var goodi16, badi16 = test_sub(int16(-0x2000), int16(0x2000))
...
func TestSSubU16(t *testing.T) {
	// var goodu16, badu16 = test_sub(uint16(0), uint16(math.MaxUint16))
	var goodu16, badu16 = test_sub(uint16(0), uint16(0x2000))
